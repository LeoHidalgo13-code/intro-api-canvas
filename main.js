...
*/
 ...
 ctx.stroke();
*/
 //combinaciones de lineas y figuras
 /* 
 ctx.beginPath();
 ctx.moveTo(75, 40);
 ...
 ctx.fill();
 */
//Combinaciones de kineas y figuras
if (canvas.getContext) {
    const ctx = canvas.getContext("2d");

    roundedRect(ctx, 15, 12, 185, 150, 15);
    roundedRect(ctx, 19, 19, 175, 150, 9);
